...
xv_path="/data/xilinx/Vivado/2016.4"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot mp7wrapped_pfalgo3_full_0 xil_defaultlib.mp7wrapped_pfalgo3_full_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim mp7wrapped_pfalgo3_full_0 -key {Behavioral:sim_1:Functional:mp7wrapped_pfalgo3_full_0} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/data/xilinx/Vivado/2016.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mp7wrapped_pfalgo3_full_0.wdb xsim.dir)
