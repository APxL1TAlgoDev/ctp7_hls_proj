...
#
# Generated by export_simulation on Wed Jul 26 02:24:03 CEST 2017
#
################################################################################
...
switch to the './hls_demo_0.sh' script.

./hls_demo_0.sh -reset_run
...
./hls_demo_0.sh -noclean_files

For more information on the script, please type './hls_demo_0.sh -help'.
